/*
Author       : Dreamguys
Template Name: POS - Alfa Software
*/
...
$(document).ready(function(){
    ...
    if($('.datetimepicker').length > 0 ){
        $('.datetimepicker').datetimepicker({
            ...
            if ($(this).attr('id') == 'filter_refund_datefrom' || $(this).attr('id') == 'filter_refund_dateto') {
            ...
            if ($(this).attr('id') == 'filter_cd_datefrom' || $(this).attr('id') == 'filter_cd_dateto') {
                ShowCloseDrawerReport();
            }
            if ($(this).attr('id') == 'filter_cxc_datefrom' || $(this).attr('id') == 'filter_cxc_dateto') {
                ShowCxcReport();
            }
        });
    }
    ...
    var customize_link = '<div class="customizer-links">' +
        ...
        '<li class="sidebar-icons">' +
        '<a href="javascript:void(0);" class="add-setting" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
        '<img src="/vendor/img/icons/sidebar-icon-01.svg" class="feather-five" alt="">' +
        '</a>' +
        '</li>' +
        '<li class="sidebar-icons">' +
        '<a href="javascript:void(0);" class="navigation-add" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
        ...
        '<a class="sidebar-close" href="javascript:void(0);"><img src="/vendor/img/icons/close-icon.svg" alt=""></a>' +
        '</div>' +
