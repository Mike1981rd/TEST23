(function ($) {
    ...
    var methods = {
        init: function (params) {
            ...
            if (params.bootstrap == 3) {
                ...
                defaults.button = '<button id="colorpaletterbuttonid" name="colorpalettebutton" class="{buttonClass}" data-toggle="dropdown" data-bs-toggle="dropdown"  aria-haspopup="true" aria-expanded="true"><span name="{buttonPreviewName}" style="display:none">■ </span>{buttonText} <span class="caret"></span></button>';
    ...
    $.fn.colorPalettePicker.defaults = {
        button: '<button name="colorpalettebutton" class="{buttonClass}" data-toggle="dropdown" data-bs-toggle="dropdown" style="width: 150px;">{buttonText}</button>',
        ...
        palette: ['black', 'white', 'aqua', 'azure', 'beige', 'brown', 'cyan', 'darkcyan', 'darkgrey', 'darkkhaki', 'darkorange', 'darkorchid', 'darksalmon', 'fuchsia', 'gold', 'green', 'khaki', 'lightblue', 'lightcyan', 'lightgreen', 'lightgrey', 'lightpink', 'lightyellow', 'lime', 'magenta',  'orange', 'pink',  'yellow'],
        lines: 1,
        bootstrap: 4,
        onSelected: null
    };
